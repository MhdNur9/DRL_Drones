...
#####################################################################################
    ...
    # object_throwing=RewTerm(func=mdp.object_throwing_check,weight=250,
    #                         params={"std": 0.05, "minimal_height": 0.3, "command_name": "Target_pose",
    #                                 "ee_distance_release": 0.1, "Vxy_velocity": 1.5}, )
