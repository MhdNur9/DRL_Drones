...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    bs_table = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=[0, 1.8, 0], rot=[0.707, 0, 0, 0.707]),
        spawn=UsdFileCfg(usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/SeattleLabTable/table_instanceable.usd"),
    )
    ...
    basket = AssetBaseCfg(
        ...
        # init_state=AssetBaseCfg.InitialStateCfg(pos=[0.0, 1.5, 0.0], rot=[0.707, 0, 0, 0.707]),
        init_state=AssetBaseCfg.InitialStateCfg(pos=[0.0, 1.65, 0.0], rot=[0.707, 0, 0, 0.707]),
    ...
    belt1 = AssetBaseCfg(
        prim_path="{ENV_REGEX_NS}/belt1",
        init_state=AssetBaseCfg.InitialStateCfg(pos=[0.0, 0.9, -1.28], rot=[0.0, 0, 0, 0.0]),
        spawn=UsdFileCfg(usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Conveyors/ConveyorBelt_A06.usd",scale=[4.5,0.8,0.7]),
    )
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        object_vel = ObsTerm(func=mdp.object_velocity)
...
class EventCfg:
    ...
    reset_object_position = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (0.3, 0.45), "y": (-0.35, 0.35), "z": (0.0, 0.0)}, 
            # "pose_range": {"x": (0.35, 0.35), "y": (-0.35, -0.35), "z": (0.0, 0.0)}, 
            "velocity_range": {},
...
class RewardsCfg:
    ...
    vel_check=RewTerm(func=mdp.obj_vel_release_check2,params={"Vxy_velocity": 1.5},  weight=50)
