...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # human_position = ObsTerm(func=mdp.human_position_in_robot_root_frame) # also containing some info about people
...
class EventCfg:
    ...
    reset_object_position = EventTerm(
        ...
        params={
            ...
            # "pose_range": {"x": (0.35, 0.35), "y": (-0.15, +0.15), "z": (0.0, 0.0)}, 
            "velocity_range": {},
    ...
    #         "velocity_range": {"x": (0.0,0.0), "y": (+0.3,+0.3), "z": (+0.0, +0.0), "roll": (0.0,0.0), "pitch": (0.0,0.0), "yaw": (0.0,0.0)},
