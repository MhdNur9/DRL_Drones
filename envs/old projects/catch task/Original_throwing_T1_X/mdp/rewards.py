...
def object_ee_distance(
    ...
    if object_ee_distance < 0.07:
        # print("object_ee_distance = ",object_ee_distance)
        print("reaching the cube")
...
def reward_gripper_release_mid_throw(
    ...
    if object.data.root_pos_w[:, 2] .item() > 0.1:
        print("lifted")
    #     # print(" gripper computed applied_torque = ", robot.data.applied_torque)
    print(" gripper computed joint positions = ", robot.data.joint_pos[0][-2:])
    print(" gripper computed_torque = ", robot.data.computed_torque[0][-2:])
    print(" gripper applied_torque = ", robot.data.applied_torque[0][-2:])
    print(datetime.now())
