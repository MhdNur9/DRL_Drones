...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    basket = AssetBaseCfg(
        ...
        # init_state=AssetBaseCfg.InitialStateCfg(pos=[1.3, 0, 0.0], rot=[0.707, 0, 0, 0.707]),
        init_state=AssetBaseCfg.InitialStateCfg(pos=[1.5, 0, 0.0], rot=[0.707, 0, 0, 0.707]),
        spawn=UsdFileCfg(usd_path="/home/mirpalab-sim/RL_catch/assets/basket/basket.usd",scale=[1.2,1.2,1.0]),
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        object_speed = ObsTerm(func=mdp.object_velocity)
...
class RewardsCfg:
    ...
    vel_check=RewTerm(func=mdp.obj_vel_release_check2,params={"Vxy_velocity": 1.25},  weight=50)
