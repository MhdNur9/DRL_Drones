...
from envs.throwv0.mdp.observations import bsk_pos_in_robot_root_frame
...
def obj_vel_release_check(
    ...
    # print("Before vel_state = ",vel_state)
...
def obj_vel_release_check2(
    ...
    vel_x = obj_vel[:, :1]
    # print("vel_x = ",vel_x)
    # print("Vxy_velocity = ",Vxy_velocity)
    vel_state=torch.where((vel_x > Vxy_velocity),1,0)
    vel_state=vel_state[0]
