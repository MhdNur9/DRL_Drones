...
def object_position_in_robot_root_frame(
    ...
    # print("actual joint_torque = ", robot.data.applied_torque)
    # print("computed joint_torque = ", robot.data.computed_torque)
...
def object_ee_distance_obs(
    ...
    # print("object_ee_distance_obs = ",object_ee_distance,(1 - torch.tanh(object_ee_distance / std)).unsqueeze(1))
