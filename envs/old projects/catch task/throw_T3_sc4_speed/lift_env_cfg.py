...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    #     spawn=UsdFileCfg(usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/SeattleLabTable/table_instanceable.usd",scale=[0.5,0.5,1.2]),
    # )
    ...
    basket = AssetBaseCfg(
        ...
        # init_state=AssetBaseCfg.InitialStateCfg(pos=[1.15, 0, 0.0], rot=[0.707, 0, 0, 0.707]),
    ...
    #     spawn=UsdFileCfg(usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Conveyors/ConveyorBelt_A06.usd",scale=[0.9,0.5,0.7]),
    # )
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        human_pos=ObsTerm(func=mdp.human_position_in_robot_root_frame) 
...
class EventCfg:
    ...
    #         # "velocity_range": {"x": (0.0,0.0), "y": (+0.5,+0.5), "z": (+0.0, +0.0), "roll": (0.0,0.0), "pitch": (0.0,0.0), "yaw": (0.0,0.0)},
