...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    basket = AssetBaseCfg(
        ...
        # init_state=AssetBaseCfg.InitialStateCfg(pos=[1.15, 0, 0.1], rot=[0.707, 0, 0, 0.707]),
...
class EventCfg:
    ...
    people_moving = EventTerm(
        ...
        params={
            ...
            "velocity_range": {"x": (0.0,0.0), "y": (+0.4,+0.4), "z": (+0.0, +0.0), "roll": (0.0,0.0), "pitch": (0.0,0.0), "yaw": (0.0,0.0)},
...
class RewardsCfg:
    ...
    vel_check=RewTerm(func=mdp.obj_vel_release_check1,params={"Vxy_velocity": 1.0},  weight=50)
