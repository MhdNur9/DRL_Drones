...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    #     init_state=AssetBaseCfg.InitialStateCfg(pos=[0.45, 0.35, -1.24], rot=[-0.707, 0, 0, 0.707]),
    #     spawn=UsdFileCfg(usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Conveyors/ConveyorBelt_A06.usd",scale=[0.5,0.6,0.7]),
    # )
...
# reset_all = EventTerm(func=mdp.reset_scene_to_default, mode="reset")
    ...
    reset_object_position = EventTerm(
        ...
        params={
            ...
            "pose_range": {"x": (0.35, 0.35), "y": (-0.05, +0.05), "z": (0.0, 0.0)}, 
            "velocity_range": {},
            "asset_cfg": SceneEntityCfg("object", body_names="Object"),
        },
    )
