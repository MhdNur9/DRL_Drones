...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    basket = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=[1.5, 0, 0.105], rot=[0.707, 0, 0, 0.707]),
...
class RewardsCfg:
    ...
    object_goal_tracking_fine_grained = RewTerm(func=mdp.object_goal_distance,weight=5.0,
    ...
    #     params={"std": 0.3, "minimal_height": 0.04, "command_name": "Target_pose"},       
    # )
    # object_velocity_toward_goal = RewTerm(func=mdp.object_velocity_toward_goal,
    #     weight=2.0,params={"goal_name": "Target_pose"}
    # )
    ...
    # object_inside_basket=RewTerm(func=mdp.object_inside_basket,weight=+20)
