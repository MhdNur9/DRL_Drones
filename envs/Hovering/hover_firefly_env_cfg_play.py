...
class RewardsCfg:
    ...
    pos_error_tanh = RewTerm(func=mdp.pos_error_tanh, weight=15.0,
                    params={"target_pos": [2.0, 2.0, 2.5], "std": 2.0})
    
    pos_error_tanh_far = RewTerm(func=mdp.pos_error_tanh, weight=15.0,
                    params={"target_pos": [2.0, 2.0, 2.5], "std": 1.0})
    
    pos_error_tanh_fine_tune_mid = RewTerm(func=mdp.pos_error_tanh, weight=25.0,
                    params={"target_pos": [2.0, 2.0, 2.5], "std": 0.3})
    
    pos_error_tanh_very_fine = RewTerm(func=mdp.pos_error_tanh, weight=25.0,
                    params={"target_pos":[2.0, 2.0, 2.5], "std": 0.1})
    
    # vel_toward = RewTerm(func=mdp.vel_toward_target, weight=13.0,
    #                 params={"target_pos":[2.0, 2.0, 2.5]}) 
    vel_toward = RewTerm(func=mdp.vel_toward_target, weight=30.0,
                    params={"target_pos":[2.0, 2.0, 2.5]}) 
