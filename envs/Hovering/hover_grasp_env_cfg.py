...
import envs.Hovering.mdp_simple_drone as mdp
from assets.drone.simple_drone import simple_drone_CFG
...
class HoverSceneCfg(InteractiveSceneCfg):
    ...
    # drone
    robot: ArticulationCfg = simple_drone_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
