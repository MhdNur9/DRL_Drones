...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    table = AssetBaseCfg(
        ...
        spawn=UsdFileCfg(usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/SeattleLabTable/table_instanceable.usd",scale=[0.8,0.5,1.0]),
    )
    ...
    bs_table = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=[1.7, -0.5, 0], rot=[0.707, 0, 0, 0.0]),
        spawn=UsdFileCfg(usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/SeattleLabTable/table_instanceable.usd",scale=[1.0,3.0,1.0]),
    )
    ...
    basket2 = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=[1.5, 0.75, 0.0], rot=[0.707, 0, 0, 0.707]),
        spawn=UsdFileCfg(usd_path="/home/mirpalab-sim/RL_catch/assets/basket/basket.usd",scale=[1.2,1.2,1.0]),
    )
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        Obj_bsk_tracking_with_bsk_pos=ObsTerm(func=mdp.obj_bsk_distance_obs,params={"command_name": "Target_pose"})
...
class EventCfg:
    ...
    #     mode="reset",
    #     params={
    #         "pose_range": {"x": (1.5, 1.5), "y": (+0.15, +0.15), "z": (0.8, 0.8)}, 
    #         "velocity_range": {},
    #         "asset_cfg": SceneEntityCfg("object", body_names="Object"),
    #     },
    # )
...
class RewardsCfg:
    ...
    vel_check=RewTerm(func=mdp.obj_vel_release_check,params={"std": 0.05, "minimal_height": 0.24, "command_name": "Target_pose",
                                     "ee_distance_release": 0.1, "Vxy_velocity": 1.5},  weight=50)
    
    # # # adding later as bonus
    object_inside_basket=RewTerm(func=mdp.object_inside_basket2,weight=150)
