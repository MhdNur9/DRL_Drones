...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    basket = AssetBaseCfg(
        ...
        # just in testing
        # init_state=AssetBaseCfg.InitialStateCfg(pos=[0.0, 1.6, 0.0], rot=[0.707, 0, 0, 0.707]),
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        Obj_bsk_tracking_with_bsk_pos=ObsTerm(func=mdp.obj_bsk_distance_obs,params={"std": 75, "minimal_height": 0.04, "command_name": "Target_pose"})
        target_object_position = ObsTerm(func=mdp.generated_commands, params={"command_name": "Target_pose"})
        # bsk_pos=ObsTerm(func=mdp.bsk_pos_in_robot_root_frame)
...
class EventCfg:
    ...
    #     mode="reset",
    #     params={
    #         "pose_range": {"x": (0.2, 0.4), "y": (-0.45, -0.45), "z": (0.0, 0.0)}, 
    #         "velocity_range": {},
    #         "asset_cfg": SceneEntityCfg("object", body_names="Object"),
    #     },
    # )
...
class RewardsCfg:
    ...
    releasing_cube=RewTerm(func=mdp.reward_gripper_release_mid_throw,params={"minimal_height": 0.24, "Vxy_velocity": 1.5}, weight=500)
