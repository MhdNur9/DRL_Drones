...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    #     spawn=UsdFileCfg(usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Conveyors/ConveyorBelt_A06.usd",scale=[4.5,0.9,0.7]),
    # )
...
class EventCfg:
    ...
    reset_object_position = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (0.35, 0.35), "y": (-0.25, 0.25), "z": (0.0, 0.0)}, 
            # "pose_range": {"x": (0.2, 0.5), "y": (-0.45, -0.45), "z": (0.0, 0.0)}, 
            "velocity_range": {},
