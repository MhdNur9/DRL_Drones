...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    #     init_state=AssetBaseCfg.InitialStateCfg(pos=[0.0, 1.5, -0.1], rot=[0.707, 0, 0, 0.707]),
...
class EventCfg:
    ...
    #     mode="reset",
    #     params={
    #         "pose_range": {"x": (0.3419, 0.3419), "y": (-0.0241, -0.0241), "z": (0.0854, 0.0854)}, # there is a shift in X by 0.5
    #         "velocity_range": {        
    #             "x": (2.2328, 2.2328),
    #             "y": (-0.2433,-0.2433),
    #             "z": (1.3892,1.3892),
