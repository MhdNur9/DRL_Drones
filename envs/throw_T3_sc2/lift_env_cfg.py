...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    # target object: will be populated by agent env cfg
    # person1: RigidObjectCfg = RigidObjectCfg()



    # person1 = RigidObjectCfg(
    ...
    #     joint_pos={".*": 0.0},
    # ),
    # actuators={},  # No control if person is passive
    # )

    # person1 = AssetBaseCfg(
    #     prim_path="{ENV_REGEX_NS}/person1",
    #     init_state=AssetBaseCfg.InitialStateCfg(pos=[-0.8, -2.8, 0.0], rot=[0.707, 0, 0, 0.707]),
