...
from envs.velocity.velocity_env_cfg import LocomotionVelocityRoughEnvCfg
...
class AnymalBRoughEnvCfg_PLAY(AnymalBRoughEnvCfg):
    def __post_init__(self):
        ...
        self.scene.terrain.visual_material=sim_utils.PreviewSurfaceCfg(diffuse_color=(0.1, 0.9, 0.9), metallic=0.2)
