...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    #     init_state=AssetBaseCfg.InitialStateCfg(pos=[1.2, 0, 0.0], rot=[0.707, 0, 0, 0.707]),
    #     # init_state=AssetBaseCfg.InitialStateCfg(pos=[1.5, 0, 0.0], rot=[0.707, 0, 0, 0.707]),
    #     spawn=UsdFileCfg(usd_path="/home/mirpalab-sim/RL_catch/assets/basket/basket.usd",scale=[0.8,1.2,1.2]),
    # )
    ...
    basket1 = AssetBaseCfg(
        ...
        spawn=UsdFileCfg(usd_path="/home/mirpalab-sim/RL_catch/assets/basket/basket.usd",scale=[0.9,1.7,1.4]),
    )

    basket2 = AssetBaseCfg(
        prim_path="{ENV_REGEX_NS}/Basket2",
        init_state=AssetBaseCfg.InitialStateCfg(pos=[1.4, 0.55, 0.0], rot=[0.707, 0, 0, 0.707]),
        spawn=UsdFileCfg(usd_path="/home/mirpalab-sim/RL_catch/assets/basket/basket.usd",scale=[0.9,1.7,1.4]),
    )
...
class EventCfg:
    ...
    #     mode="reset",
    #     params={
    #         "pose_range": {"x": (1.8, 1.8), "y": (-0.77, -0.77), "z": (0.4, 0.4)}, 
    #         "velocity_range": {},
    #         "asset_cfg": SceneEntityCfg("object", body_names="Object"),
    #     },
    # )
    ...
    # reset_object_position = EventTerm(
    #     func=mdp.belt_moving,
    #     mode="reset",
    #     params={
    #         "pose_range": {"x": (0.2, 0.5), "y": (-0.55, -0.55), "z": (0.0, 0.0)}, 
    #         "velocity_range": {},
    #         "asset_cfg": SceneEntityCfg("object", body_names="Object"),
    #     },
    # )
    ...
    #obj pos =  tensor([[ 0.3419, -0.0241,  0.0854]], device='cuda:0')
# obj vel =  tensor([[ 2.2328, -0.2433,  1.3892]], device='cuda:0')
...
class RewardsCfg:
    ...
    vel_check=RewTerm(func=mdp.obj_vel_release_check,params={"Vxy_velocity": 0.85},  weight=50)
