...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    basket = AssetBaseCfg(
        ...
        spawn=UsdFileCfg(usd_path="/home/mirpalab-sim/RL_catch/assets/basket/basket.usd",scale=[1.2,1.2,1.4]),
        )
...
class EventCfg:
    ...
    reset_object_position = EventTerm(
        ...
        params={
            ...
            # "pose_range": {"x": (0.25, 0.45), "y": (-0.45, -0.3), "z": (0.0, 0.0)}, 
            "velocity_range": {},
            "asset_cfg": SceneEntityCfg("object", body_names="Object"),
        },
    )

    # robot_limiting_vel = EventTerm(
    #     func=mdp.robot_limiting_vel,
    #     mode="interval",
