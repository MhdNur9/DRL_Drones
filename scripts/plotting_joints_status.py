...
def save_all_joint_plots_pdf(Data, max_steps: int = 250, save_dir: str = "Data"):
    ...
    with PdfPages(filename) as pdf:
        ...
        if "robot joint effort limits" in series_dict:
            plot_metric_all_joints(series_dict["robot joint effort limits"], "Effort Limits", "Nm", pdf, max_steps)
        if "robot joint effort target" in series_dict:
            plot_metric_all_joints(series_dict["robot joint effort target"], "Effort Targets", "Nm", pdf, max_steps)
