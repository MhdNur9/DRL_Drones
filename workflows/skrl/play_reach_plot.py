...
from scripts.plotting_reach_KPIs import *
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, experiment_cfg: dict):
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            ...
            data_entry = {
                ...
                "robot joint effort limits": info["robot joint effort limits"],
                "robot joint effort target": info["robot joint effort target"],
                "robot ee_frame": info["robot ee_frame"],
                "command_pos_w": info["command_pos_w"],
                "EE - Command distance": info["EE - Command distance"],
                "EE - Command distance in 3D": info["EE - Command distance in 3D"],
                "EE - Command orientation error": info["EE - Command orientation error"],
    ...
    save_all_joint_plots_pdf(Data, max_steps=500)
    plot_all(Data)
    plot_agent_vs_robot_final(Data, max_steps=500)
    #
